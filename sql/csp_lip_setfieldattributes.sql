IF EXISTS (SELECT name FROM sysobjects WHERE name = 'csp_lip_setfieldattributes' AND UPPER(type) = 'P')
   DROP PROCEDURE [csp_lip_setfieldattributes]
GO
